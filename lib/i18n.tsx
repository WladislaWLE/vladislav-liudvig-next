...
export const translations = {
  ru: {
    ...
    hero: {
      ...
      stats: [
        { value: 0, display: "Global", suffix: "", label: "клиенты по всему миру" },
  ...
  en: {
    ...
    hero: {
      ...
      stats: [
        { value: 0, display: "Global", suffix: "", label: "clients worldwide" },
    ...
    testimonials: {
      ...
      items: [
        ...
        },
        {
          ...
          date: "03.02.2026",
          text: "Before working with Vladislav, our team spent 20 hours a week on manual reporting. Now it's all automated and takes minutes. A real game-changer.",
        },
        {
          name: "David Miller",
